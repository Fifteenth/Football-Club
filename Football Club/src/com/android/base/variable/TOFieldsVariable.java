package com.android.base.variable;

public class TOFieldsVariable {
	
	// FinanceTO
	final public static String FINANCETO_PLAYER = "player";
	...
	final public static String FINANCETO_DESCRIPTION = "description";
