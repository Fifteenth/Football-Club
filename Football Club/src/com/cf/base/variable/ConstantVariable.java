...
public class ConstantVariable {
	...
	public static String MENU_LEFT_START = "开始";
	public static String MENU_LEFT_NEXT = "下一步";
	public static String MENU_LEFT_PAUSE = "暂停";
	public static String MENU_LEFT_STOP = "结束";
	public static String MENU_LEFT_TACTICAL_DISPLAY = "演练";
	public static String MENU_LEFT_SETTING = "设置";
	
	public static String MENU_BUTTOM_FORMATION_SELECT = "选择阵型";
	public static String MENU_BUTTOM_FORMATION_SAVE = "保存阵型";
	public static String MENU_BUTTOM_FILE_READ = "读档";
	public static String MENU_BUTTOM_FILE_SAVE = "存档";
	...
	public static String PLAY_TYPE_C_ = "player_c_";
	...
	//
	public static String DIALOG_TITLE_TACTICAL_CN = "载入...";
	public static String DIALOG_TITLE_TACTICAL_DETAIL_CN = "详细";
