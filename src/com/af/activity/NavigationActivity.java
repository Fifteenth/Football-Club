...
//					break;
				...
				case 8:
					Intent leagueActivity = new Intent(NavigationActivity.this,LeagueActivity.class);
					startActivity(leagueActivity);
					break;
					
				case 9:
					Intent scorersActivity = new Intent(NavigationActivity.this,ScorersActivity.class);
					startActivity(scorersActivity);
					break;
