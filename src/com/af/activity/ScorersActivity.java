...
import com.af.adapter.ScorersAdapter;
...
public class ScorersActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.activity_scorers);
		listView = (ListView) this.findViewById(R.id.listview_scorers);
		adapter = new ScorersAdapter(this,list);
		...
		new Thread(){
			...
			@Override
			 public void run(){
				...
				httpCilent.setUrl("http://5522s.cn/league/getScorers");
				try{
